const skillData = {
	skillList: [
		{
			label: "HTML/CSS",
			detail: ["원하는 UI를 실용적이고, 익숙하게 만들어 낼 수 있습니다.", "빌드시스템(Gulp)과 템플릿 엔진(node js)의 사용이 가능합니다.", "Css 최신 문법이 숙지되어 있고 Css 프리프로세서 Sass를 사용할 수 있습니다."],
			icon: "fab fa-html5",
		},
		{
			label: "jQuery",
		...
		{
			label: "Node.js",
			detail: ["Node.js가 작동하는 법에 대해 이해하고 있습니다.", "모델, 라우터, 컨트롤러, 서비스를 나누어 구조화된 서버를 만들 수 있습니다."],
			icon: "fab fa-node",
		},
		{
			label: "Git/Github",
	...
	educationList: [
	
		{
			...
			company: "슈퍼코딩",
			explain: "Node.js를 이용하여 비동기 통신 방식의 자바스크립트 프로그램 제작, React.JS의 편리한 반응형 렌더링과 상태를 관리하는 캡슐화된 컴포넌트 개발 기술을 습득하였습니다. Vitual DOM을 활용한 랜더링의 비효율성을 최소화 하기 위하여 힘썼습니다.",
		},
		{
			period: "2023.01 - 2023.05",
			position: "리액트(React.js)프로그래밍과정",
			company: "KH 정보교육원 당산지점",
